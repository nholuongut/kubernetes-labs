...
![stars](https://img.shields.io/github/stars/nholuongut/kubernetes-labs)
![forks](https://img.shields.io/github/forks/nholuongut/kubernetes-labs)
![issues](https://img.shields.io/github/issues/nholuongut/kubernetes-labs)
![GitHub contributors](https://img.shields.io/github/contributors/nholuongut/kubernetes-labs)
...
### PWK:
  ...
  - [Running Portainer on 5 Node Kubernetes Cluster](https://github.com/nholuongut/kubernetes-labs/tree/master/portainer#running-portainer-on-5-node-kubernetes-cluster)
...
### Ubuntu
  ...
  - [Setting up Kubernetes on Ubuntu](https://github.com/nholuongut/kubernetes-labs/blob/master/install/ubuntu/README.md)
...
- [Kubetail](https://github.com/nholuongut/kubernetes-labs/blob/master/pods101/tools/kubetail.md)
...
## Services101
  ...
  - [Labels and Selectors](https://github.com/nholuongut/kubernetes-labs/blob/master/Labels-and-Selectors/README.MD)
...
```
 git clone https://github.com/nholuongut/kubernetes-labs
```
